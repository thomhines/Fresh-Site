...
<html lang="en" class="no-js">
	<head>
		...
		<title>Fresh Spring 2018 - PSU.GD Senior Showcase - <?php echo ( $_GET["name"] ? ucfirst($_GET["name"]) : "Not Found" ); ?></title>
    ...
    $name = $_GET["name"];
	if ( $name && file_exists('students/spring18/'.$_GET["name"]) ) {
